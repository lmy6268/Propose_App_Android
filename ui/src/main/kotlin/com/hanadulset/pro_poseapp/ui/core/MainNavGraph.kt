...
import com.hanadulset.pro_poseapp.ui.component.AnimatedSlideToRight
import com.hanadulset.pro_poseapp.ui.core.permission.PermScreen
import com.hanadulset.pro_poseapp.ui.feature.camera.CameraViewModel
import com.hanadulset.pro_poseapp.ui.feature.camera.Screen
import com.hanadulset.pro_poseapp.ui.feature.gallery.GalleryScreen
import com.hanadulset.pro_poseapp.ui.feature.gallery.GalleryViewModel
import com.hanadulset.pro_poseapp.ui.feature.setting.SettingScreen
import com.hanadulset.pro_poseapp.ui.feature.splash.PrepareServiceScreens
import com.hanadulset.pro_poseapp.ui.feature.splash.PrepareServiceViewModel
import com.hanadulset.pro_poseapp.utils.camera.CameraStateModel
...
private fun NavGraphBuilder.notPermissionAllowGraph(
    ...
    multiplePermissionsState: MultiplePermissionsState,
    cameraInit: () -> Unit,
    previewState: State<CameraStateModel>,
) {
                    ...
                    onDeleteImage = { index ->
                        coroutineScope.launch {
                            ...
                            deleteImage(
                                ...
                                galleryViewModel,
                                index = index,
                                uri = imageList.value!![index].dataProposeUriString
                            )
