package com.hanadulset.pro_poseapp.ui.feature.setting
...
import com.hanadulset.pro_poseapp.ui.component.SettingBoxItem
import com.hanadulset.pro_poseapp.ui.component.SettingBoxItemWithToggle
import com.hanadulset.pro_poseapp.utils.UserSetModel

object SettingScreen {
    @Composable
    fun Screen(
        modifier: Modifier = Modifier,
        userSet: UserSetModel,
        onSaveUserSet: (UserSetModel) -> Unit,
        onBackPressed: () -> Unit
    ) {
        ...
        LaunchedEffect(key1 = setState.value) {
            setState.value.run {
                onSaveUserSet(
                    UserSetModel(isCompOn, isPoseOn)
                )
            }
        }
...
private fun TestSettingScreen() {
    SettingScreen.Screen(userSet = UserSetModel(true), onSaveUserSet = {
