...
import com.hanadulset.pro_poseapp.ui.mapper.toUIUri
...
class GalleryViewModel @Inject constructor(
    ...
    private val _capturedImageState = MutableStateFlow<List<ImageResultModel>?>(null)
    ...
    fun deleteImage(index: Int, isOnDialog: Boolean) {
        ...
        viewModelScope.launch {
            val checkState = isOnDialog || deleteImageFromPicturesUseCase(uri = _capturedImageState.value!![index].toUIUri() as ProposeUri)
            if (checkState) {
